                    ...
                    <div className="slider-section_item-bg">
                        <div className="slider-section-grid">
                            <div className="slider-section-grid-item">
                                <Image width={546} height={372} className="img-fluid slider-section-grid-item-img1" src="/slider-1.jpg" alt="" />
                            </div>
                        ...
                        <div className="slider-section-grid">
                            ...
                            <div className="slider-section-grid-item">
                            <Image width={546} height={372} className="img-fluid slider-section-grid-item-img2" src="/slider-2.jpg" alt="" />
                            </div>
                        </div>
                    </div>
